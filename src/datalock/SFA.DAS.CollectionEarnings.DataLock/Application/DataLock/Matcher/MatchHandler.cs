...
namespace SFA.DAS.CollectionEarnings.DataLock.Application.DataLock.Matcher
{
    public abstract class MatchHandler
    {
        ...
        public abstract MatchResult Match(List<Commitment.Commitment> commitments, Infrastructure.Data.Entities.LearnerEntity learner);

        protected MatchResult ExecuteNextHandler(List<Commitment.Commitment> commitments, Infrastructure.Data.Entities.LearnerEntity learner)
        {
